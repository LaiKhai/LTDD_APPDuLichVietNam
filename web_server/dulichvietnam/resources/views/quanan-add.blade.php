...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" method="POST" action="{{route('quanan.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="exampleInputName1">Tên quán ăn</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="sdt" class="form-control" id="exampleInputName1">
                    @if ($errors->has('sdt'))
                    <small style="color:red">{{$errors->first('sdt')}}</small> <br>
                    @endif
                </div>
                <div class="form-group">
                    <label for="exampleTextarea1">Địa chỉ</label>
                    <textarea name="diachi" class="form-control" id="exampleTextarea1" rows="10"></textarea>
                    @if ($errors->has('diachi'))
                    <small style="color:red">{{$errors->first('diachi')}}</small> <br>
                    @endif
                </div>
                <div class="form-group">
